...
/**
 * This class demonstrates how to access the open DrugBank dataset. This datasets 
 * contains identifiers and names for integration with other data resources. 
 * 
...
//	    Dataset<Row> drugLinks = DrugBankDataset.getDrugLinks(DrugGroup.APPROVED, username, password);
//	    drugLinks.show();
